...
const Form = () => {
  ...
  const defaultInputClasses =
    "w-full text-center h-10 px-3 text-base placeholder-opacity-50 placeholder-gray-600 border rounded-lg focus:outline-none focus:ring focus:border-blue-300";
    ...
    >
      <div className="flex p-2 flex-col">
        <div className="w-full m-2 px-2">
          <label className="block mb-1 text-white" htmlFor="habitName">
        ...
        <div className="w-full m-2 px-2">
          <label className="block mb-1 text-white" htmlFor="habitDescription">
            A short description..
          </label>
          <input
            id="habitDescription"
        ...
        <div className="w-full m-2 px-2">
          <label className="block text-white mb-1" htmlFor="habitStartDate">
            Start from:
          </label>
          <input
            disabled
